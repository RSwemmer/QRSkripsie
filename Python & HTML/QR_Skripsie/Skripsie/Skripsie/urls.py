...
from sample_sense_app import views
...
urlpatterns = [
    ...
    path("view_client/<client_id>", views.view_client, name="view_client"),
    path("update_client/<client_id>", views.update_client, name="update_client"),
    ...
    path("delete_feed_sample/<sample_id>", views.delete_feed_sample, name="delete_feed_sample"),
    ...
    path("delete_residue_sample/<sample_id>", views.delete_residue_sample, name="delete_residue_sample"),
] 